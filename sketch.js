...
let emojis = []
let currentEmoji = 0
let starStruckImage, foxFaceImage;

function preload() {
  starStruckImage = loadImage('starstruck.png')
  foxFaceImage = loadImage('fox.png')
}
...
function setup() {
  ...
  emojis = ["🤩", "🦊"]
  emojiImages = [starStruckImage, foxFaceImage]
  drawEmoji()
  drawNav()
}
...
drawEmoji = () => {
  ...
  image(emojiImages[currentEmoji], windowWidth / 2 - emojiSize / 2, windowHeight / 2 - emojiSize / 2 - 0.1 * windowHeight, emojiSize, emojiSize)
}
...
drawNav = () => {
  ...
  image(emojiImages[0], windowWidth / 4 - navEmojiSize / 2, height - 0.18 * windowHeight + navEmojiSize / 2, navEmojiSize, navEmojiSize)
  ...
  image(emojiImages[1], windowWidth * 3 / 4 - navEmojiSize / 2, height - 0.18 * windowHeight + navEmojiSize / 2, navEmojiSize, navEmojiSize)
}
